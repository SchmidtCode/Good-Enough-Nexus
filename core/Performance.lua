...
function Performance.InstallDefaults()
    local targets = {
        ...
        {"leaderboard.open", Nexus.Leaderboard, "Show"},
        {"leaderboard.refresh", Nexus.Leaderboard, "RefreshData"},
        {"leaderboard.projection", Nexus.ViewProjections, "Leaderboard"},
        {"leaderboard.board", Nexus.DpsCapture, "GetDpsBoard"},
        {"leaderboard.status", Nexus.Leaderboard, "RefreshStatus"},
