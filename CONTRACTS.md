# Nexus — internal module contracts (v1.96.5)
...
local M = {}; Nexus.<Name> = M`). Version: `Nexus.VERSION = "1.96.5"`
comes from `data/Release.lua`; .toc `## Version: 1.96.5` stays in lockstep.
