# Nexus — internal module contracts (v1.96.4)
...
local M = {}; Nexus.<Name> = M`). Version: `Nexus.VERSION = "1.96.4"`
comes from `data/Release.lua`; .toc `## Version: 1.96.4` stays in lockstep.
