...
assert.strictEqual(Packager.tocVersion(toc), "1.96.3",
...
assert.deepStrictEqual(Packager.validateIdentity("v1.96.3",
    "SchmidtCode/Better-Nexus", toc, release).version, "1.96.3");
Packager.validateRuntimeIdentity("1.96.3",
...
assert.throws(() => Packager.validateRuntimeIdentity("1.96.3", "", ""),
