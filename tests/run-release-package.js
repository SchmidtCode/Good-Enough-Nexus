...
assert.strictEqual(Packager.tocVersion(toc), "1.96.4",
...
assert.deepStrictEqual(Packager.validateIdentity("v1.96.4",
    "SchmidtCode/Good-Enough-Nexus", toc, release).version, "1.96.4");
Packager.validateRuntimeIdentity("1.96.4",
...
assert.throws(() => Packager.validateRuntimeIdentity("1.96.4", "", ""),
