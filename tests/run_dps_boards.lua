...
assert(not DPS.ReceiveRecord({v=4,f=fb,e=b,c="dummy",d=23000000,u=65,t=103,g=100,p="Alpha",k="MAGE",l=80}),"lower second loadout in the same owner generation accepted")
